...
// Figuring out the syntax for first child was tricky, I did not realize at first the the key had to be Carson: to make it pass.

//How difficult was it to add and delete properties outside of the object itself?
//It was a pretty straight forward process.  Its interesting that you can use either a dot or brackets to do so

//What did you learn about manipulating objects in this challenge?
//Lots of the tools you need to do so.  Both keywords and formating needed to change objects.
